...
class GANModel(jt.nn.Module):
    ...
    def initialize_networks(self, opt):
        ...
        if opt.g_pretrained != '':
            ...
            print("Using pretrained weight for G...")
    ...
    def compute_discriminator_regularization(self, real_sketch, real_image):
        ...
        r1_loss=networks.L1loss()(self.D_params)
        loser = self.opt.r1 / 2 * r1_loss * self.opt.d_reg_every
        D_reg_losses['D_r1_loss_image']=loser
        D_reg_losses['D_r1_loss_sketch']=loser
